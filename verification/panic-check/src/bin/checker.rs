...
//! Host binary that checks a firmware ELF for panic-related symbols.
//!
//! Usage:
//!   cargo run --bin checker --features std -- <path-to-firmware-elf>
...
/// Panic-related symbol patterns to search for in the ELF binary.
