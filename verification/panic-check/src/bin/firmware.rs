...
//! Firmware binary that exercises DPE code for panic verification.
//!
//! This binary is built for embedded targets (e.g., riscv32imc-unknown-none-elf)
//! and should not contain any panic-related symbols when compiled with the
//! firmware profile.
